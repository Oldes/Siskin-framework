Red/System [
	Title:   "Red/System OpenGL3 colored cube example"
	Author:  "Oldes"
...
camPosition: make-vec3f 4.0 3.0 3.0 ;Camera is at (4,3,3), in World Space
camTarget:   make-vec3f 0.0 0.0 0.0 ;and looks at the origin
camHead:     make-vec3f 0.0 1.0 0.0 ;Head is up (set to 0 -1 0 to look upside-down)
...
mat4f-perspective projection  45.0 (800.0 / 600.0) 0.1 100.0
;Or, for an ortho camera :
;mat4f-orthographic projection -8.0 8.0 -6.0 6.0 0.0 100.0
...
mat4f-multiply mvp model camera     ; mvp = View * Model
mat4f-multiply mvp projection mvp ; mvp = Projection * View * Model

;mat4f-assign mvp model
mat4f-multiply mvp projection model 
mat4f-scaling mvp 0.5 0.5 0.5
...
render-scene: does [
	...
	glUniformMatrix4fv matrixID 1 GL_FALSE as pointer! [float32!] mvp
